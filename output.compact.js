/* GENERATED_FROM=input.js SOURCE_SHA256=51ae1213ea19befe17d9a4c3ff4fb2eaeb751e388b89f3328d454033de1a984f FORMAT=READABLE_COMPACT PRINT_WIDTH=320 BLANK_LINES=SAFE_REMOVE DO_NOT_EDIT */
...
const startPushPolling = () => {
  ...
  const loop = async () => {
    ...
    await poll();
    clearTimeout(_pushTimer);
    _pushTimer = setTimeout(loop, Math.min(90000, 30000 + _pushFails * 15000));
  };
  loop();
};
